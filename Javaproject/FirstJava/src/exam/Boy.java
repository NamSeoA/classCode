...
//  게임 후 승리 메서드 : 게임을 할 대상(Boy), 구슬의 개수
...
//   다음조건을 만족하는 인스턴스를 각각 생성하자.
		...
		Boy boy1 = new Boy();   //boy1, boy2는 서로 다른 애, 저장장소도 다르고 값도 다르기 때문에
		Boy boy2 = new Boy();
...
//   어린이 2의 보유자산  구슬 9개
		...
		System.out.println("게임 시작할 때의 어린이들의 보유한 구슬의 정보입니다.");
		boy1.showData();
		boy2.showData();
...
//   “1차 게임에서 어린이 1은 어린이 2의 구슬 2개를 획득한다”
		...
		boy1.playWin(boy2, 2);
		System.out.println("\n1차 게임 : 어린이1이 승리해서 구슬 2개를 획득하였습니다.");
		boy1.showData();
		boy2.showData();
		
//  “2차 게임에서 어린이 2는 어린이 1의 구슬 7개를 획득한다.”
		boy2.playWin(boy1, 7);
		System.out.println("\n2차 게임 : 어린이2가 승리하여 구슬 7개를 획득하였습니다.");
		boy1.showData();
		boy2.showData();
