...
public class PhoneBookManager {
	...
	// 배열에 친구 전화번호 정보를 저장하는 메서드 (매개변수 참조값)
	private	void addInfor(PhoneInfor info) {
			pBook[cnt++] = info;
		}
		
		
	// 사용자에게 입력받고 -> 전화번호 정보를 인스턴스 생성하고 배열에 저장
	public void insertInfo() {
		
		// 입력된 정보가 저장할 수 있는 공간보다 클 때.
	...
	//삭제
	// 사용자에게 이름을 입력 받고 이름으로 검색한 후 정보를 삭제 
